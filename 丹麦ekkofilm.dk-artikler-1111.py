...
class NewsSpider:
    def __init__(self):
        ...
        self.host_header = "https://www.ekkofilm.dk/artikler/"  # 相当于host，用于拼接全详情也URL
    ...
    def parse_url_list(self, html):
        ...
        # url_list2 = html.xpath("///div[@class='main overview ']/div/div/a/@href")
        # url_list2 = html.xpath("///div[@class='main overview ']/div/div/a/@href")
    ...
    def get_url_list(self):
        ...
        for i in range(1, 5):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
            # i = i
            pageCount = i * 1
    ...
    def get_content_list(self, html_str):
        ...
        #
        contents2 = html.xpath("//div[@class='main detail ']/div/div/p/text()")
        contents3 = html.xpath("html/body/div[@class='container']/div[@id='article']/div[@class='left']/div[@class='text']/p/text()")
        #
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('丹麦ekkofilm.dk-artikler-1111.txt', 'a', encoding='utf-8') as f:
