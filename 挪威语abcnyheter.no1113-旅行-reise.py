...
class NewsSpider:
    def __init__(self):
        self.url_temp = "https://www.abcnyheter.no/json/category/Reise/?offset={}"  # 用于拼接的URL地址，加大括号是为了format赋值
    ...
    def get_url_list(self):
        ...
        for i in range(400, 500):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
            # i = i
            pageCount = i * 10
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('挪威语abcnyheter.no1113-旅行-reise.py.txt', 'a', encoding='utf-8') as f:
