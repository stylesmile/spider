...
class NewsSpider:
    def __init__(self):
        self.url_temp = "http://laos.cri.cn/news/International-{}"  # 用于拼接的URL地址，加大括号是为了format赋值
        self.url_temp_header = "http://laos.cri.cn/news/International"  # 首页URL地址
        self.host_header = "http://laos.cri.cn"  # 相当于host，用于拼接全详情也URL
    ...
    def parse_url_list(self, html):
        ...
        url_list = html.xpath("//div[@class='list-box']/ul/li/a/@href")
        return url_list

    def get_url_list(self):
        # 构造URL列表页网址，拼接补全详情页URL，并加入到队列
        for i in range(1, 101):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('老挝国际新闻.txt', 'a', encoding='utf-8') as f:
