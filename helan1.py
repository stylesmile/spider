...
class NewsSpider:
    def __init__(self):
        """分页列表的地址"""
        self.url_temp = "https://www.filmtotaal.nl/nieuws?page={}"  # 用于拼接的URL地址，加大括号是为了format赋值
        self.url_temp_header = "https://www.filmtotaal.nl/nieuws"  # 首页URL地址
        self.host_header = "https://www.filmtotaal.nl/"  # 相当于host，用于拼接全详情也URL
        self.headers = {
            "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3"}
        self.queue = Queue()  # 实例化一个队列
        self.pool = Pool(20)  # 实例化一个线程池，最大为20
    ...
    def get_url_list(self):
        ...
        for i in range(2030, 2050):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
            try:
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('荷兰电影咨询2000-2050.txt', 'a', encoding='utf-8') as f:
