...
class NewsSpider:
    def __init__(self):
        ...
        self.pool = Pool(10)  # 实例化一个线程池，最大为10
    ...
    def get_url_list(self):
        ...
        for i in range(1001, 4000):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
            # i = i
            pageCount = i * 10
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('挪威语abcnyheter.no1108-1500-4000.txt', 'a', encoding='utf-8') as f:
