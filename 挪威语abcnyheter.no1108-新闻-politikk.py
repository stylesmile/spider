...
class NewsSpider:
    def __init__(self):
        self.url_temp = "https://www.abcnyheter.no/nyheter/politikk/?offset={}"  # 用于拼接的URL地址，加大括号是为了format赋值
        self.url_temp_header = "https://www.abcnyheter.no/nyheter/politikk"  # 首页URL地址
        self.host_header = "https://www.abcnyheter.no/nyheter/politikk"  # 相当于host，用于拼接全详情也URL
    ...
    def get_url_list(self):
        ...
        for i in range(1, 100):  # range为左闭右开，表示从1到100循环，i代表每次循环的值
            # i = i
            pageCount = i * 10
    ...
    def save_content_list(self, content_list):
        # 保存数据到本地
        with open('挪威语abcnyheter.no1111-新闻-politikk.py.txt', 'a', encoding='utf-8') as f:
